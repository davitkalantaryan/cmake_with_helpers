...
isEmpty(cmakeWithHelpersPrivateFlagsAndSysCommonIncluded){
    cmakeWithHelpersPrivateFlagsAndSysCommonIncluded = 1

    include("$${PWD}/flagsandsys_common.pri")

    INCLUDEPATH += $${cmakeWithHelpersRepositoryRoot}/src/include
}
